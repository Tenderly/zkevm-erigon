...
devs first on [Discord server](https://github.com/tenderly/zkevm-erigon#erigon-discord-server) to 
...
Please see the [Readme](https://github.com/tenderly/zkevm-erigon#readme) file
