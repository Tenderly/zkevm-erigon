...
CGO_CFLAGS += -Wno-error=strict-prototypes # for Clang15, remove it when can https://github.com/tenderly/zkevm-erigon/issues/6113#issuecomment-1359526277
...
PACKAGE = github.com/tenderly/zkevm-erigon
