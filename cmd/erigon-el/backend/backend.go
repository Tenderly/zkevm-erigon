...
import (
	...
	"github.com/tenderly/zkevm-erigon/zk/txpool/txpooluitl"

	"github.com/0xPolygonHermez/zkevm-data-streamer/datastreamer"
	log2 "github.com/0xPolygonHermez/zkevm-data-streamer/log"
	chain2 "github.com/gateway-fm/cdk-erigon-lib/chain"
	"github.com/tenderly/zkevm-erigon/cmd/erigon-el/eth1"
	stages3 "github.com/tenderly/zkevm-erigon/cmd/erigon-el/stages"
	...
	"github.com/tenderly/zkevm-erigon/consensus/clique"
	...
	"github.com/tenderly/zkevm-erigon/ethstats"
	"github.com/tenderly/zkevm-erigon/node"
	"github.com/tenderly/zkevm-erigon/p2p"
	"github.com/tenderly/zkevm-erigon/p2p/dnsdisc"
...
func NewBackend(stack *node.Node, config *ethconfig.Config, logger log.Logger) (*Ethereum, error) {
	...
	apiList := commands.APIList(chainKv, borDb, ethRpcClient, txPoolRpcClient, miningRpcClient, ff, stateCache, backend.blockReader, backend.agg, httpRpcCfg, backend.engine, config, nil)
