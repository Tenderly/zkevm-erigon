...
with open('/Users/alexeyakhunov/workspace/src/github.com/tenderly/zkevm-erigon/badger.log') as f:
    lines = f.readlines()
...
with open('/Users/alexeyakhunov/workspace/src/github.com/tenderly/zkevm-erigon/badger.csv', 'w') as w:
